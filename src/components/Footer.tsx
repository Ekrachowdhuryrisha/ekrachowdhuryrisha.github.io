    ...
    <section id="contact" className="section-container">
      ...
      >
        ...
        <p className="section-subtitle mx-auto mt-3">
          I'm actively seeking AI/ML internship opportunities where I can contribute to real-world Machine Learning, LLM, and Backend Development projects. If you're looking for a passionate learner and developer, I'd love to connect.
        </p>
      ...
      <footer className="mt-16 border-t border-border/50 pt-8 text-center">
        <p className="text-xs text-muted-foreground">
         © {new Date().getFullYear()} {ABOUT_ME.name}. Built with React,
