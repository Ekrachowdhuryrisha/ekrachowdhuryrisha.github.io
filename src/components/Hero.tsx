...
const LINKEDIN_URL = "https://www.linkedin.com/in/ekra-chowdhury-risha/";
        ...
        <div className="grid items-center gap-10 md:grid-cols-5 md:gap-12">
          ...
          <div className="md:col-span-3">
            ...
            <motion.p
              ...
              className="mt-6 max-w-xl text-muted-foreground leading-8"
            >
              Passionate about building intelligent software using
              ...
              Currently seeking an AI/ML internship where I can learn, contribute,
